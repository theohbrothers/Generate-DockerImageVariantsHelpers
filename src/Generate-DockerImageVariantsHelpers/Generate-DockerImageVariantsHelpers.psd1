#
# Module manifest for module 'Generate-DockerImageVariantsHelpers'
#
...
FunctionsToExport = 'Automerge-DockerImageVariantsPR', 'Clone-TempRepo', 
               'Execute-Command', 'Get-DockerImageVariantsVersions', 
               'Get-GitBranchSlug', 'Get-TagNext', 'Get-VersionsChanged', 
               'New-DockerImageVariantsPR', 'New-DockerImageVariantsVersions', 
               'New-Release', 'Set-DockerImageVariantsVersions', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'continuous-deployment','continuous-integration','docker','generate-dockerimagevariants','helpers'
