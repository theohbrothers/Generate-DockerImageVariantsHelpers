...
FunctionsToExport = 'Clone-TempRepo', 'Execute-Command', 
               'Get-DockerImageVariantsVersions', 'Get-VersionsChanged', 
               'New-DockerImageVariantsPR', 'Set-DockerImageVariantsVersions', 
